...
var encodedData = require('soop').load('nanocore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('nanocore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('nanocore/lib/Address', {
