...
var home = process.env.INSIGHT_DB || (getUserHome() + '/.nanosight');
...
if (!dataDir) {
  ...
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/nanocoin/';
  if (isLinux) dataDir = process.env.HOME + '/.nanocoin/';
}
...
var bitcoindConf = {
  ...
  user: process.env.BITCOIND_USER || 'nanocoinrpc',
  pass: process.env.BITCOIND_PASS || '6yVkXPy5vGsEvAP7YFKCZ1YchZuPFNa9pP2hHW9E6RSZ',
